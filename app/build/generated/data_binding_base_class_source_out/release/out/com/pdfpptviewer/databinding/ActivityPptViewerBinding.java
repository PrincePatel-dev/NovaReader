...
public final class ActivityPptViewerBinding implements ViewBinding {
  ...
  private ActivityPptViewerBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout controlsLayout, @NonNull Button nextButton, @NonNull Button prevButton,
      @NonNull ConstraintLayout rootLayout, @NonNull TextView slideContentText,
      @NonNull TextView slideInfoText, @NonNull ScrollView slideScrollView) {

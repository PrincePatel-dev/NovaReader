...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Button openPdfButton;

  @NonNull
  public final Button openPptButton;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull SwitchMaterial darkModeSwitch, @NonNull Button openPdfButton,
      @NonNull Button openPptButton, @NonNull TextView statusText, @NonNull TextView titleText) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button openPdfButton = ViewBindings.findChildViewById(rootView, id);
      if (openPdfButton == null) {
        break missingId;
      }

      id = R.id.openPptButton;
      Button openPptButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, darkModeSwitch, openPdfButton,
          openPptButton, statusText, titleText);
    }
